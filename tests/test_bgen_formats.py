...
class TestBgenFormats(unittest.TestCase):
    ...
    def test_compare_with_reference_16bit(self):
        ...
        np.testing.assert_allclose(ldcov_dosages, ref_dosages, rtol=0.0001, atol=0.0001, equal_nan=True)
