...
std::string VariantParser::readLengthPrefixedString(
    const uint8_t* buffer,
    size_t& pos,
    size_t max_size,
    bool use_32bit_length
) {
...
std::pair<VariantMetadata, size_t> VariantParser::parseV11(
    const uint8_t* buffer,
    size_t size,
...
std::pair<VariantMetadata, size_t> VariantParser::parseV12(
    const uint8_t* buffer,
    size_t size
) {
    VariantMetadata variant;
...
std::pair<VariantMetadata, size_t> VariantParser::parse(
    const uint8_t* buffer,
    size_t size,
    LayoutType layout,
    CompressionType compression,
...
size_t VariantParser::getVariantMetadataSize(
    const uint8_t* buffer,
    size_t size,
    LayoutType layout
) {
...
size_t VariantParser::skipVariant(
    const uint8_t* buffer,
    size_t size,
    LayoutType layout,
    CompressionType compression,
...
std::vector<VariantMetadata> BatchVariantParser::parseBatch(
    const uint8_t* buffer,
    size_t size,
    LayoutType layout,
    CompressionType compression,
