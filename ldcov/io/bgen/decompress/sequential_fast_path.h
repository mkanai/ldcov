...
public:
    ...
    struct Config {
        ...
        Config() : initial_buffer_size(4 * 1024 * 1024),  // 4MB
                   enable_prefetch(true),
                   prefetch_distance(64) {}  // Cache line prefetch distance
    };
    
    explicit SequentialFastPath(ldcov::io::bgen::FileReader* reader, const Config& config = Config());
    ~SequentialFastPath();
     ...
     */
    size_t decompress_batch_direct(
