...
public:
     ...
     */
    static void convert_probabilities_to_dosages_8bit(
        const uint8_t* probs,
        float* dosages,
        size_t n_samples,
        uint8_t ploidy = 2
     ...
     */
    static void convert_probabilities_to_dosages_16bit(
...
private:
    ...
    static void convert_probabilities_scalar_8bit(
        const uint8_t* probs,
        float* dosages,
        size_t n_samples,
        uint8_t ploidy
    ...
    static void convert_probabilities_scalar_16bit(
        const uint16_t* probs,
        float* dosages,
        size_t n_samples,
        uint8_t ploidy
    ...
    static void convert_probabilities_avx2_8bit(
        const uint8_t* probs,
        float* dosages,
        size_t n_samples,
        uint8_t ploidy
    ...
    static void convert_probabilities_sse2_8bit(
        const uint8_t* probs,
        float* dosages,
        size_t n_samples,
        uint8_t ploidy
    ...
    static void convert_probabilities_neon_8bit(
        const uint8_t* probs,
        float* dosages,
        size_t n_samples,
        uint8_t ploidy
