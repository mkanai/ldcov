...
std::pair<std::unique_ptr<uint8_t[]>, CompressionResult> decompress_with_allocation(
    const uint8_t* compressed, size_t compressed_size, size_t expected_size,
